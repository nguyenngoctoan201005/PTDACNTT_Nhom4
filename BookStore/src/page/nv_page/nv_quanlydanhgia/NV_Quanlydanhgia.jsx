        ...
        <>
            ...
            <main className='nv_trangdgbl_main'>
                ...
                <div className="nv_trangdgbl_chitietdanhgia">
                    <div className="nv_trangdgbl_chitietdanhgia_tieude">Chi tiết đánh giá</div>
                    ...
                    <div className="nv_trangdgbl_chitietdanhgia_noidung">
                        ...
                        <hr style={{ border: '1px solid gainsboro' }} />
                        <div>Thao tác : <button className="nv_trangdgbl_noidung_btnxoa">Xoá</button> <button className="nv_trangdgbl_noidung_btnan">Ẩn</button></div>
                    </div>
                </div>
            </main>
        </>

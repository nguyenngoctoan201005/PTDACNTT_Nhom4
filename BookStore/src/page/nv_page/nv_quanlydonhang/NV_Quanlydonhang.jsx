        ...
        <div>
          <table className="nv_qldh_table" width="1150px" height="50px">
            ...
            <tr className="nv_qldh_tr">
              ...
              <td>
                <div className="nv_qldh_td nv_trangqldh_trangthai">
                  chờ xác nhận
                </div>
              </td>
              <td className="nv_qldh_td nv_trangqldh_tongtien">150.000đ</td>
              <td>
                <button className="nv_qldh_td nv_trangqldh_button_xct">
                  Xem chi tiết
                </button>{" "}
            ...
            <tr className="nv_qldh_tr">
              ...
              <td>
                <div
                  className="nv_qldh_td nv_trangqldh_trangthai"
            ...
            <tr className="nv_qldh_tr">
              ...
              <td>
                <div
                  className="nv_qldh_td nv_trangqldh_trangthai"
                  style={{
                    backgroundColor: "rgba(210, 87, 87, 0.8)",
                    color: "aliceblue",
                  }}
                >
                  đã hủy

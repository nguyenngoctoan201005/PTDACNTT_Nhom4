                ...
                <div>
                    <table className='nv_huyvatrahang_table' width="1150px" height="50px" style={{ marginTop: '50px' }}>
                        ...
                        <tr className='nv_huyvatra_tr'>
                            ...
                            <td><div className="nv_huyvatra_td nv_tranghuyvatra_trangthai">đã hủy</div></td>
                            <td className="nv_huyvatra_td nv_tranghuyvatra_tongtien">150.000đ</td>
                            <td><button className="nv_huyvatra_td nv_tranghuyvatra_button">Xem chi tiết</button></td>
                        </tr>

                         <tr className='nv_huyvatra_tr'>
                            <td className="nv_huyvatra_td nv_tranghuyvatra_madh">DH001</td>
                            <td className="nv_huyvatra_td nv_tranghuyvatra_tenkh">Nguyễn Văn A</td>
                            <td className="nv_huyvatra_td nv_tranghuyvatra_ngaydat">10/10/2024</td>
                            <td><div className="nv_huyvatra_td nv_tranghuyvatra_trangthai">đã hủy</div></td>
                            <td className="nv_huyvatra_td nv_tranghuyvatra_tongtien">150.000đ</td>
                            <td><button className="nv_huyvatra_td nv_tranghuyvatra_button">Xem chi tiết</button></td>
                        </tr>

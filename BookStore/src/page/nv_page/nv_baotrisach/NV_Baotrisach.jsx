    ...
    <>
      ...
      <main className="nv_trangbts_main">
        ...
        <div className="nv_trangbts_noidung">
          ...
          <table
            className="nv_trangbts_noidung_table"
            width="1150px"
            height="50px"
          >
            <tr className="nv_trangbts_noidung_thongtinsach">
              <th style={{ width: "70px" }} className="trangbts_th">
                Mã sách
              </th>
              <th style={{ width: "280px" }} className="trangbts_th">
                Tên sách
              </th>
              <th className="trangbts_th">Tác giả</th>
              <th className="trangbts_th">Thể loại</th>
              <th className="trangbts_th">Giá bán</th>
              <th style={{ width: "50px " }} className="trangbts_th">
                Tồn kho
              </th>
            ...
            <tr>
              ...
              <td className="trangbts_td">
                <button className="nv_trangbts_noidung_button">
                  Chỉnh sửa
                </button>
              </td>
            </tr>

          ...
          <div className="qtv_trangbdk_noidung_tang1">
            <div className="bdkcaco qtv_trangbdk_noidung_othu1">
              ...
              <div className="bdkcaco_dltop qtv_trangbdk_noidung_othu1_dltop">
                <div className="bdkcaco_dltop_tieude qtv_trangbdk_noidung_othu1_dltop_tieude">
                ...
                <div className="bdkcaco_dltop_dl qtv_trangbdk_noidung_othu1_dltop_dl">
                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu1_dltop_dl_giatri toro_bgr1">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu1_dltop_dl_giatri1 toro_ten1">
                      1.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu1_dltop_dl_giatri2 toro_sl1">
                      1200
                    </div>
                  </div>

                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu1_dltop_dl_giatri">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu1_dltop_dl_giatri1">
                      2.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu1_dltop_dl_giatri2">
                      1100
                    </div>
                  </div>
              ...
              <div className="bdkcaco_tieude qtv_trangbdk_noidung_othu2_tieude">
                ...
                <div className="bdkcaco_tieude_icon qtv_trangbdk_noidung_othu2_tieude_icon">
                  ...
                  >
                    <path
                      fill="rgb(59 130 246)"
                      d="M7 14h2a1 1 0 0 0 0-2H7a1 1 0 0 0 0 2Zm6 2H7a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2Zm6-14H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3Zm-5 2v3.29l-1.51-.84a1 1 0 0 0-1 0L10 7.29V4Zm6 15a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3v5a1 1 0 0 0 .5.86a1 1 0 0 0 1 0L12 8.47l2.51 1.4A1 1 0 0 0 15 10a1 1 0 0 0 1-1V4h3a1 1 0 0 1 1 1Z"
                    />
                  </svg>
                </div>
              </div>
                ...
                <div className="bdkcaco_dlphu1dong qtv_trangbdk_noidung_othu2_dlphu1">
                  <div className="bdkcaco_dlphu1dong_tieude qtv_trangbdk_noidung_othu2_dlphu_tieude">
                    ...
                    >
                      <path
                        fill="#DC2626"
                        d="M1000 501q0 136-67 251T751 934t-251 67t-251-67T67 752T0 501t67-251T249 68T500 1t251 67t182 182t67 251zM661 733l71-71l-161-161l161-161l-71-71l-161 161l-161-161l-71 71l161 161l-161 161l71 71l161-161z"
                      />
                    </svg>{" "}
                    Đã hủy
                  </div>
          ...
          <div className="qtv_trangbdk_noidung_tang2">
            <div className="bdkcaco qtv_trangbdk_noidung_othu3">
              <div className="bdkcaco_tieude qtv_trangbdk_noidung_othu3_tieude">
                ...
                <div className="bdkcaco_tieude_icon qtv_trangbdk_noidung_othu3_tieude_icon">
                  ...
                  >
                    <path
                      fill="#EA580C"
                      d="M10 2c4.42 0 8 3.58 8 8s-3.58 8-8 8s-8-3.58-8-8s3.58-8 8-8zm1.13 9.38l.35-6.46H8.52l.35 6.46h2.26zm-.09 3.36c.24-.23.37-.55.37-.96c0-.42-.12-.74-.36-.97s-.59-.35-1.06-.35s-.82.12-1.07.35s-.37.55-.37.97c0 .41.13.73.38.96c.26.23.61.34 1.06.34s.8-.11 1.05-.34z"
                    />
                  </svg>{" "}
                </div>
              </div>
              ...
              <div className="bdkcaco_dltop qtv_trangbdk_noidung_othu3_dltop">
                <div className="bdkcaco_dltop_tieude qtv_trangbdk_noidung_othu3_dltop_tieude">
                  Top 5 sách tồn kho cao :
                </div>
                <div className="bdkcaco_dltop_dl qtv_trangbdk_noidung_othu3_dltop_dl">
                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu3_dltop_dl_giatri toro_bgr2">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu3_dltop_dl_giatri1 toro_ten2">
                      1.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu3_dltop_dl_giatri2 toro_sl2">
                      1200
                    </div>
                  </div>

                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu3_dltop_dl_giatri">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu3_dltop_dl_giatri1">
                      2.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu3_dltop_dl_giatri2">
                      1100
                    </div>
                  </div>
            ...
            <div className="bdkcaco qtv_trangbdk_noidung_othu4">
              ...
              <div className="bdkcaco_dltop qtv_trangbdk_noidung_othu4_dltop">
                <div className="bdkcaco_dltop_tieude qtv_trangbdk_noidung_othu4_dltop_tieude">
                  Top 5 khách hàng có chi tiêu cao nhất :
                </div>
                <div className="bdkcaco_dltop_dl qtv_trangbdk_noidung_othu4_dltop_dl">
                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu4_dltop_dl_giatri toro_bgr2">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu4_dltop_dl_giatri1 toro_ten2">
                      1.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu4_dltop_dl_giatri2 toro_sl2">
                      1200
                    </div>
                  </div>

                  <div className="bdkcaco_dltop_dl_giatri qtv_trangbdk_noidung_othu4_dltop_dl_giatri">
                    <div className="bdkcaco_dltop_dl_giatri1 qtv_trangbdk_noidung_othu4_dltop_dl_giatri1">
                      2.Đắc nhân tâm
                    </div>
                    <div className="bdkcaco_dltop_dl_giatri2 qtv_trangbdk_noidung_othu4_dltop_dl_giatri2">
                      1100
                    </div>
                  </div>

    ...
    <>
      ...
      <main className="qtv_qlnhanvien_main">
        <div className="qtv_qlnhanvien_tieude">
          <div className="qtv_qlnhanvien_tieude_tt">Quản Lý Nhân Viên</div>
        ...
        <div className="qtv_qlnhanvien_noidung">
          <table className="qtv_qlnhanvien_table">
            <tr className="qtv_qlnhanvien_table_tr">
              <th className="qtv_qlnv_th qtv_qlnhanvien_table_th1">
                NHÂN VIÊN
              </th>
              <th className="qtv_qlnv_th qtv_qlnhanvien_table_th2">SỐ CCCD</th>
              <th className="qtv_qlnv_th qtv_qlnhanvien_table_th3">
                TÊN ĐĂNG NHẬP
              </th>
            ...
            <tr className="qtv_qlnhanvien_table_tr">
              <td className="qtv_qlnv_td qtv_qlnhanvien_table_td1">
                Nguyễn Văn A
              </td>
              <td className="qtv_qlnv_td qtv_qlnhanvien_table_td2">
                00120000334
              </td>
              <td className="qtv_qlnv_td qtv_qlnhanvien_table_td3">
                nguyenvana##
              </td>
              <td className="qtv_qlnv_td qtv_qlnhanvien_table_td4">
                nguyenvana99
              </td>
        ...
        <div className="qtv_qlnhanvien_themnhanvien">
          <div className="qtv_qlnhanvien_themnhanvien_tieude">
            Thêm nhân viên mới{" "}
          </div>
          <div className="qtv_qlnhanvien_themnhanvien_noidung">
            <div className="qtv_qlnhanvien_themnhanvien_nhapdl">
              <div className="qtv_qlnhanvien_themnhanvien_nhapdl_nhan">
                Họ và tên
              </div>
          ...
          <div className="qtv_qlnhanvien_themnhanvien_button">
            <div className="qtv_qlnhanvien_themnhanvien_button_nhan">
              Thêm nhân viên
            </div>
          </div>
        </div>
        ...
        <div className="qtv_qlnhanvien_suanhanvien">
          <div className="qtv_qlnhanvien_suanhanvien_tieude">
            Sửa thông tin nhân viên
          </div>
          <div className="qtv_qlnhanvien_suanhanvien_noidung">
            <div className="qtv_qlnhanvien_suanhanvien_nhapdl">
              <div className="qtv_qlnhanvien_suanhanvien_nhapdl_nhan">
                Họ và tên
              </div>
              <input type="text" placeholder="Nhập họ và tên" />
            </div>
          ...
          <div className="qtv_qlnhanvien_suanhanvien_button">
            <div className="qtv_qlnhanvien_suanhanvien_button_nhan1">
              Lưu thông tin
            </div>
            <div className="qtv_qlnhanvien_suanhanvien_button_nhan2">
              Hủy bỏ
            </div>
          </div>
        </div>

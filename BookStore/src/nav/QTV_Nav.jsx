    ...
    return (
        <nav className="qtv_nav">
            ...
            <div className="qtv_nav_chucnang">
                ...
                <Link to="/qtvbangdieukhien"><div>Bảng điều khiển</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                ...
                <Link to="/qtvquanlysach"><div>Quản lý sách</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
                ...
                <Link to="/qtvquanlytheloai"><div>Quản lý thể loại</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 344 384">
                    <path
                ...
                <Link to="/qtvkhachhang"><div>Khách hàng</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 36 36" fill="#000000">
                ...
                <Link to="/qtvquanlynhanvien"><div>Quản lý nhân viên</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 628 717">
                    <path
                        d="M454 194h121c29 0 53 23 53 53v182H340V217c-10-3-19-7-25-13c-1 0-1-1-2-1c0 0 0 1-1 1c-7 6-15 10-24 13v212H0V247c0-30 23-53 52-53h122c-14-7-27-17-38-26c-48-46-57-110-19-146c16-14 37-22 60-22c33 0 67 13 96 40c16 15 31 36 40 56c10-20 25-41 41-56c28-27 64-40 96-40c24 0 45 8 60 22c38 36 29 100-20 146c-10 9-23 19-36 26zm-178-29c4-9-6-55-39-86c-17-16-40-25-60-25c-6 0-16 1-23 7c-2 2-8 6-8 17c0 13 8 33 27 50c24 23 62 39 90 39c9 0 13-2 13-2zm76 0s5 2 13 2c28 0 66-16 90-39c19-17 25-37 25-50c0-11-5-15-6-17c-7-6-18-7-24-7c-19 0-43 9-60 25c-32 31-43 76-38 87v-1zm-64 552H52c-29 0-52-23-52-52V482h288v235zm287 0H340V482h288v183c0 29-24 52-53 52z" />
                </svg>
                <Link to="/qtvquanlykhuyenmai"><div>Quản lý khuyến mãi</div></Link>
            </div>
            <div className="qtv_nav_chucnang">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 1025 1024"><path fill="" d="M320.9 704v-32l131-177q5-20 22-33.5t39-13.5q21 0 38 12.5t23 32.5l195 243v32h-32l-225-181l-159 117h-32zm192 320q-104 0-197.5-39.5T150.9 874l91-90q53 53 123 82.5t148 29.5q104 0 192.5-51.5t140-140T896.9 512t-51.5-192.5t-140-140T512.9 128q-94 0-175 43t-135 116l54 54q0 18-12.5 30.5T214.9 384h-171q-18 0-30.5-12.5T.9 341V171q0-17 12.5-29.5T43.9 129l68 67q71-91 176-143.5T512.9 0q104 0 199 40.5t163.5 109t109 163.5t40.5 199t-40.5 199t-109 163.5t-163.5 109t-199 40.5z" /></svg>
                <Link to="/qtv_lichsu"><div>Lịch sử chỉnh sửa</div></Link>
            </div>

        
            <div className="qtv_nav_chucnang qtv_nav_chucnang_icon_logout">
                <svg width="200" height="200" viewBox="0 0 20 20"><path fill="" d="M17 17H9v2h8c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2H9v2h8z" /><path fill="" d="M7 15v-4h8V9H7V5l-6 5z" /></svg>
                Đăng xuất
            </div>
        </nav>
    )

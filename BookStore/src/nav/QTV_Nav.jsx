...
export function QTV_Nav() {
  return (
    <nav className="qtv_nav">
      ...
      <div className="qtv_nav_chucnang">
        <svg
        ...
        <Link to="/admin/qtvbangdieukhien">
      ...
      <div className="qtv_nav_chucnang">
        ...
        <Link to="/admin/qtvquanlytheloai">
      ...
      <div className="qtv_nav_chucnang">
        ...
        <Link to="/admin/qtvquanlynhanvien">
      ...
      <div className="qtv_nav_chucnang">
        ...
        <Link to="/admin/qtvquanlykhuyenmai">
